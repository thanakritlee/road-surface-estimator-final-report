...
\\
In file \textit{.$\backslash$src$\backslash$app$\backslash$app-services$\backslash$area-calculation$\backslash$area-calculation.services.ts}:
\\
comment out the line :
\\
\textit{private serverApi = 'api/area$\_$calculation/';}
\\
and uncomment the line :
\\
\textit{private serverApi = 'http://localhost:8080/api/area$\_$calculation/';}
\\
